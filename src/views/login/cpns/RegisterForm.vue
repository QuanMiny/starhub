<template>
  <el-form ref="registerFormRef" :model="registerAccount" :rules="rules">
    ...
    <el-form-item prop="password">
      <el-input v-model="registerAccount.password" type="password" show-password placeholder="请输入密码">
        <template #prefix> <i class="iconfont icon-lock"></i> </template>
      </el-input>
    </el-form-item>
    <el-form-item prop="confirmPassword">
      <el-input v-model="registerAccount.confirmPassword" type="password" show-password placeholder="请再次输入密码">
        <template #prefix>
